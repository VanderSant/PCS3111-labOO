...
Competicao* PersistenciaDeCompeticao::carregar(string arquivo) {
    ...
    if (verificador == 1) {
        CompeticaoMultimodalidades* CompMult = new CompeticaoMultimodalidades(NomeCompeticao, equipesCompeticao,
                                                                              QuantidadeDeEquipes);
    ...
    if (verificador == 0) {
        ...
        CompeticaoSimples* CompSimp = new CompeticaoSimples(NomeCompeticao, equipesCompeticao, QuantidadeDeEquipes,
                                                            modalidadeCS);
        return CompSimp;
    }
